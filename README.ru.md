...
Kernelyra 0.3.0a1 — библиотека для обучения и дообучения табличных моделей из
...
- [Датасеты и входные форматы обучения](docs/datasets.md)
- [Backends](docs/backends.md)
- [Python и SDK API](docs/sdk.md)
- [План 0.4](docs/roadmap-0.4.md)
- [Лицензия](LICENSE)
